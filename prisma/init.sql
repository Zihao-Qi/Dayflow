...
CREATE INDEX IF NOT EXISTS "Habit_status_sortOrder_idx" ON "Habit" ("status", "sortOrder");
...
CREATE UNIQUE INDEX IF NOT EXISTS "HabitCheckIn_habitId_date_key" ON "HabitCheckIn" ("habitId", "date");
CREATE INDEX IF NOT EXISTS "HabitCheckIn_date_idx" ON "HabitCheckIn" ("date");
